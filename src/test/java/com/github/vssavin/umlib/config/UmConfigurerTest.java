...
public class UmConfigurerTest {
    ...
    public void passwordValid() {
        ...
        UmConfigurer umConfigurer = initUmConfigurer(minPasswordLength, false,
                false, false,false);
        ...
        umConfigurer = initUmConfigurer(minPasswordLength, true, false,
                false, false);
        ...
        umConfigurer = initUmConfigurer(minPasswordLength, false, true,
                false, false);
        ...
        umConfigurer = initUmConfigurer(minPasswordLength, false, false,
                true, false);
        ...
        umConfigurer = initUmConfigurer(minPasswordLength, true, true,
                true, true);
    ...
    public void passwordNotValid() {
        int minPasswordLength = 5;
        UmConfigurer umConfigurer = initUmConfigurer(minPasswordLength, true, true,
                true, true);
        Assertions.assertFalse(umConfigurer.getPasswordPattern().matcher("lksajdfhkjdh").matches(),
                String.format("Password doesn't match the pattern: %s", umConfigurer.getPasswordPattern()));
    }

    private UmConfigurer initUmConfigurer(int passwordMinLength, boolean atLeastOneDigit, boolean atLeastOneLowerCaseLatin,
                                        boolean atLeastOneUpperCaseLatin, boolean atLeastOneSpecialCharacter) {
        UmConfigurer umConfigurer = new UmConfigurer();
        umConfigurer.passwordConfig().minLength(passwordMinLength).atLeastOneDigit(atLeastOneDigit)
                .atLeastOneLowerCaseLatin(atLeastOneLowerCaseLatin).atLeastOneUpperCaseLatin(atLeastOneUpperCaseLatin)
