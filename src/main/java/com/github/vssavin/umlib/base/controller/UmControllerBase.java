 ...
 * {@link org.springframework.web.servlet.ModelAndView} as their return type. Contains
 * methods for adding various objects to model map with predefined attribute names using
 * specified language.
 *
...
public class UmControllerBase {
    ...
    /**
     * Creates a new {@link UmControllerBase} with {@link UmLanguage} and {@link UmConfig}
     * params.
     ...
     * @param modelAndView {@link org.springframework.web.servlet.ModelAndView} instance
     * to add all elements
     * @param elements collection to be added to modelAndView
     * {@link org.springframework.web.servlet.ModelAndView} instance
    ...
    protected void addObjectsToModelAndView(ModelAndView modelAndView, Collection<String> elements,
        ...
        if (modelAndView != null) {
            ...
            if (elements != null && !page.isEmpty()) {
                elements.forEach(
                        param -> modelAndView.addObject(param, LocaleConfig.getMessage(page, param, requestedLang)));
            }
        ...
        if (viewName == null) {
            ...
            if (elements != null) {
                elements.forEach(param -> modelAndView.addObject(param,
                        LocaleConfig.getMessage(viewName, param, requestedLang)));
            }
    ...
    /**
     * Adds all elements from the requestMap to
     * {@link org.springframework.web.servlet.ModelAndView} instance except for elements
     * from the ignored collection
     * @param modelAndView {@link org.springframework.web.servlet.ModelAndView} instance
     * to add all elements
     ...
     * success response using requested language
    ...
    /**
     * Generates a {@link org.springframework.web.servlet.ModelAndView} object for the
     * error response using requested language
     * @param page redirect page
     * @param messageKey the message key for specified language
     * @param lang the language
     * @param formatValues values to format the message string
     * @return the {@link org.springframework.web.servlet.ModelAndView} object with error
     * params
     */
     ...
     * @param modelAndView the instance of
